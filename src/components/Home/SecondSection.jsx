  ...
  return (
    <div>
      <div className="py-2 bg-ble-400 flex-1 relative px-2">
        ...
        <div className="w-full h-full gap-2 flex flex-wrap items-center justify-center lg:px-[50px] xl:px-20 absolute top-0 left-0 overflow-hidden md:overflow-auto">
          {imageData.map((image) => {
            return (
              <div className=" w-[150px] lg:w-[160px] lg:min-w-[160px] p-4 bg-cardOverlay backdrop-blur-md flex flex-col items-center justify-center rounded-2xl">
                <img
                  src={image.imageSrc}
                  alt="icecream"
                  className="w-20 lg:w-28 -mt-10 lg:-mt-16"
                />
